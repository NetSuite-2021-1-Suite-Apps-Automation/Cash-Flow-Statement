package com.qa.cashFlowStatementRP.ExtentReportsListeners;
...
public class ITestListenerImpl extends ExtentReportListener implements ITestListener {
	...
	public void onFinish(ITestContext context) {
		...
		try {
			sendEmail("sravan.k@tvarana.com"); //abhishek.dutta@tvarana.com
	...
	public void emailToSingleReceipient(String receipient) throws EmailException {
		...
		attachment.setPath("./Extent_report/Cashflow Statement Test Report.html");
		...
		email.setSubject("Cash Flow Statement Test Report");
		email.setMsg("Hey, Automation testing for Cash Flow Statement SuiteApp is completed. Please find the test report attached below");
